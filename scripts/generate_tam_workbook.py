...
# ── Bucket 1 line items ──────────────────────────────────────────────────────
B1_LINES = [
    # (source, line_item, performer, fy24, fy25, fy26, confidence, notes)
    ("OMN 1B4B", "Ship Modernization Program (SMP)", "Mixed", 1203816, 869253, 1197180, "High", "Year-to-year variation reflects availability phasing"),
    ("OMN 1B4B", "NME / 2-Hatch Ships", "Mixed", 1197197, 1306411, 1341155, "High", ""),
    ("OMN 1B4B", "NME / 4-Hatch Ships", "Mixed", 1247653, 1290155, 1289894, "High", ""),
    ("OMN 1B4B", "NME / Submarine Availability", "Public Yard", 871537, 896253, 924629, "High", "Primarily NNSY / PHNSY"),
    ("OMN 1B4B", "NME / Industrial Base", "Mixed", 1245621, 1270256, 1267865, "High", ""),
    ("OMN 1B4B", "NME / NAVPLAN", "Mixed", 1134835, 1139556, 1134328, "High", ""),
    ("OMN 1B4B", "NME / SSN-to-Repair", "Public Yard", 630555, 639229, 642190, "High", "Public yard submarine repair"),
    ("OMN 1B4B", "NME / Carrier", "Mixed", 762048, 816344, 784000, "High", ""),
    ("OMN 1B4B", "NME / Amphibious", "Private", 569696, 656000, 624506, "High", ""),
    ("OMN 1B4B", "NME / LCS", "Private", 481854, 539000, 492493, "High", ""),
    ("OMN 1B4B", "NME / DDG", "Private", 758318, 758610, 749000, "High", ""),
    ("OMN 1B4B", "MSC M&R (transfer from NWCF)", "Private", 0, 0, 1584000, "Medium", "New FY26 transfer; no FY24/FY25 comparables"),
    ("OMN 1B4B", "Residual NME rounding / discrepancy", "Mixed", None, None, -176024, "Low", "SAG total controls; sub-element sum slightly below"),
    ("OPN BA1", "L26 Ship Maint, Repair & Modernization", "Private", 2839179, 2392190, 2392620, "High", ""),
    ("USCG O&S", "Bucket 1 share (60% of vessel O&S 25.7)", "Mixed", 329409, 335840, 369358, "Medium", "Analyst allocation: 60% of ~$616M vessel share"),
]

# ── Bucket 2 line items ──────────────────────────────────────────────────────
B2_LINES = [
    ("OMN 1B4B", "CMMP (Continuous Maint & Modernization)", "Mixed", 1259925, 1303227, 1321948, "High", ""),
    ("OMN 1B4B", "Expedited M&M", "Mixed", 581796, 602706, 640000, "High", ""),
    ("OMN 1B5B", "RMC", "Mixed", 22311, 25633, 26529, "High", "Regional Maintenance Centers"),
    ("USCG O&S", "Bucket 2 share (40% of vessel O&S 25.7)", "Mixed", 219606, 223893, 246238, "Medium", "Analyst allocation: 40% of ~$616M vessel share"),
]

# ── Bucket 3 line items ──────────────────────────────────────────────────────
B3_BA1 = [
    ("OPN BA1", "L1 Surface Power Equipment", "Private", 12855, 20840, 9978, "High", ""),
    ("OPN BA1", "L2 Surface Combatant HM&E", "Private", 92449, 77592, 62004, "High", ""),
    ("OPN BA1", "L4 Sub Periscope, Imaging & Supt Equip", "Mixed", 272778, 290575, 277413, "High", ""),
    ("OPN BA1", "L5 DDG Mod", "Private", 641676, 861066, 997485, "High", ""),
    ("OPN BA1", "L8 LHA/LHD Midlife", "Private", 102334, 81602, 123384, "High", ""),
    ("OPN BA1", "L11 Submarine Support Equipment", "Mixed", 210652, 293766, 383062, "High", ""),
    ("OPN BA1", "L12 Virginia Class Support Equipment", "Mixed", 32055, 43565, 52039, "High", ""),
    ("OPN BA1", "L13 LCS Class Support Equipment", "Private", 17816, 7318, 2551, "High", "Declining as LCS decommissions"),
    ("OPN BA1", "L15 LPD Class Support Equipment", "Private", 80933, 38115, 125542, "High", ""),
    ("OPN BA1", "L16 DDG 1000 Class Support Equipment", "Private", 220771, 340668, 115267, "High", ""),
    ("OPN BA1", "L17 Strategic Platform Support Equip", "Mixed", 23756, 53931, 53740, "High", ""),
    ("OPN BA1", "L21 LCAC", "Private", 10239, 11013, 20321, "High", ""),
    ("OPN BA1", "L28 Reactor Components", "Mixed", 389890, 445974, 399603, "High", ""),
    ("OPN BA1", "L33 LCS Common Mission Modules", "Private", 49028, 56105, 38880, "High", ""),
    ("OPN BA1", "L34 LCS MCM Mission Modules", "Private", 87828, 118247, 91372, "High", ""),
    ("OPN BA1", "L36 LCS SUW Mission Modules", "Private", 12094, 11101, 3790, "High", ""),
    ("OPN BA1", "L37 LCS In-Service Modernization", "Private", 154561, 188254, 237728, "High", ""),
    ("OPN BA1", "L40 LSD Midlife & Modernization", "Private", 3989, 56667, 4079, "High", ""),
]
B3_BA2 = [
    ("OPN BA2", "L43 AN/SQQ-89 (100%)", "Private", 133803, 134637, 144425, "High", "100% in-service"),
    ("OPN BA2", "L44 SSN Acoustic Equipment (80%)", "Mixed", 107116, 117310, 398878, "Medium", "80% of total; FY26 ramp"),
    ("OPN BA2", "L46 Sub Acoustic Warfare System (100%)", "Mixed", 41695, 51514, 56482, "High", "100% in-service"),
    ("OPN BA2", "L50 AN/SLQ-32 SEWIP (100%)", "Private", 325996, 182011, 461380, "High", "100% in-service"),
    ("OPN BA2", "L51 Shipboard IW Exploit (100%)", "Mixed", 367452, 362099, 379908, "High", "100% in-service"),
    ("OPN BA2", "L53 CEC (95%)", "Private", 22776, 23696, 25316, "Medium", "95% of total"),
    ("OPN BA2", "L70 CANES (99%)", "Mixed", 416879, 413558, 530408, "Medium", "99% of total"),
    ("OPN BA2", "L72 CANES-Intell (99%)", "Mixed", 38283, 40128, 45813, "Medium", "99% of total"),
    ("OPN BA2", "L78 In-Service Radars and Sensors (100%)", "Private", 279545, 222607, 249656, "High", "100% in-service"),
    ("OPN BA2", "L79 Battle Force Tactical Network (100%)", "Mixed", 68327, 104119, 106583, "High", "100% in-service"),
    ("OPN BA2", "L80 Shipboard Tactical Comms (90%)", "Mixed", 14440, 15480, 18810, "Medium", "90% of total"),
    ("OPN BA2", "L81 Ship Comms Automation (75%)", "Mixed", 96000, 100800, 121556, "Medium", "75% of total"),
]
B3_BA4 = [
    ("OPN BA4", "BLI 125 Ship Gun Systems (100%)", "Private", 16250, 6416, 7358, "High", "100% in-service"),
    ("OPN BA4", "BLI 126 Harpoon (100%)", "Mixed", 227, 226, 209, "High", "100% in-service"),
    ("OPN BA4", "BLI 127 Ship Missile Support (100%)", "Mixed", 283972, 376830, 455822, "High", "100% in-service"),
    ("OPN BA4", "BLI 128 Tomahawk (70%)", "Mixed", 48696, 55392, 75396, "Medium", "70% of total"),
    ("OPN BA4", "BLI 130 Strategic Missile (50%)", "Mixed", 193500, 210000, 246500, "Medium", "50% of total"),
    ("OPN BA4", "BLI 131 SSN Combat Control (86%)", "Mixed", 67400, 72536, 88554, "Medium", "86% of total"),
    ("OPN BA4", "BLI 132 ASW Support (100%)", "Mixed", 37301, 25362, 25721, "High", "100% in-service"),
    ("OPN BA4", "BLI 134 Directed Energy / ODIN (100%)", "Private", 0, 3817, 2976, "High", "New capability"),
    ("OPN BA4", "BLI 136 Anti-Ship Missile Decoy (100%)", "Mixed", 51100, 75614, 89129, "High", "100% in-service"),
]
B3_CG = [
    ("USCG PC&I", "ISSS", "Mixed", 25000, 28000, 30000, "Medium", "In-Service Ship Systems"),
    ("USCG PC&I", "C4ISR", "Mixed", 16000, 16000, 10000, "Medium", ""),
    ("USCG PC&I", "Cyber/EMP (50% vessel share)", "Mixed", 10000, 11000, 12900, "Low", "50% vessel share estimate"),
]

# ── Bucket 4 line items ──────────────────────────────────────────────────────
B4_LINES = [
    ("SCN", "CVN RCOH Full Funding (CVN 75)", "Private (HII-NNS)", 0, 811143, 1779011, "High", "Major ramp in FY26"),
    ("SCN", "CVN RCOH Cost-to-Complete (CVN 74)", "Private (HII-NNS)", 42422, 669171, 483100, "High", "Completing CVN 74 RCOH"),
    ("SCN", "CVN RCOH Outfitting / Post-Delivery", "Private", 19704, 6660, 12200, "High", ""),
    ("SCN", "LCAC SLEP (ESLEP)", "Private (Walashek)", 15286, 45087, 37390, "High", ""),
    ("SCN", "LCAC SLEP Outfitting", "Private", 728, 0, 493, "High", ""),
    ("OPN BA1", "L9 LCC ESLP", "Private", 10522, 7352, 19276, "High", ""),
    ("USCG PC&I", "47-ft MLB SLEP", "CG Yard / Private", 43000, 43000, 45000, "Medium", ""),
    ("USCG PC&I", "270-ft WMEC SLEP", "CG Yard", 46200, 46200, 76000, "Medium", ""),
    ("USCG PC&I", "175-ft WLM MMA", "CG Yard", 17800, 17800, 15000, "Medium", ""),
    ("USCG PC&I", "CGC Healy SLEP", "Mixed", 13000, 13000, 11000, "Medium", ""),
    ("USCG PC&I", "418-ft WMSL MMA (new start)", "CG Yard", 0, 0, 5000, "Low", "New program start FY26"),
    ("USCG PC&I", "Boats RB-M SLEP portion", "Private", 1950, 1950, 9270, "Low", "Ramp-up in FY26"),
]

# ── Bucket 5 line items ──────────────────────────────────────────────────────
B5_NAVY = [
    ("OMN 1B5B", "DDG-1000 Maintenance & Support", "Mixed", 183642, 197600, 209225, "High", ""),
    ("OMN 1B5B", "Mine Countermeasures Ship Support", "Mixed", 14157, 7186, 5573, "High", "Declining with MCM decommissions"),
    ("OMN 1B5B", "PRE/PRL CV/CVN Technical Support", "Mixed", 81444, 81505, 86561, "High", ""),
    ("OMN 1B5B", "Service Craft Support, Boats/Targets Rehab", "Mixed", 7548, 8364, 6842, "High", ""),
    ("OMN 1B5B", "Surface & Amphibious Ship Support", "Mixed", 446317, 463167, 451307, "High", ""),
    ("OMN 1B5B", "Nuclear Propulsion Tech Logistics", "Mixed", 327227, 340900, 355445, "High", ""),
    ("OMN 1B5B", "SUPSHIP Costs", "Public Yard", 255302, 269204, 251345, "High", "Supervisor of Shipbuilding offices"),
    ("OMN 1B5B", "NMP Total (Navy Modernization Process)", "Mixed", 415261, 277773, 410893, "High", ""),
    ("OMN 1B5B", "NMMES", "Mixed", 103028, 104083, 115706, "High", ""),
    ("OMN 1B5B", "Smart Work / TOC", "Mixed", 22363, 34068, 23672, "High", ""),
    ("OMN 1B5B", "CSOSS", "Mixed", 12756, 11062, 14954, "High", ""),
    ("OMN 1B5B", "NAVSEA HQ Civilian Personnel & IT", "Public Yard", 571260, 628655, 579450, "High", "HQ overhead; included as enabler"),
]
B5_OTHER = [
    ("OPN BA8", "BLI 9020 Spares and Repair Parts", "Mixed", 736770, 705144, 883630, "High", ""),
]
B5_CG = [
    ("USCG O&S", "Survey & Design", "CG Yard", 5000, 5000, 5000, "Low", "Analyst estimate"),
    ("USCG O&S", "PO&M (50% vessel share)", "Mixed", 10500, 10500, 11000, "Low", "50% vessel share estimate"),
]

# ── Bucket 6 line items ──────────────────────────────────────────────────────
B6_LINES = [
    ("OMN 1B5B", "Berthing & Messing", "Mixed", 129771, 135039, 141596, "High", ""),
    ("OMN 1B5B", "Facilities / Supply Ops (incl SIOP)", "Public Yard", 120535, 87573, 81780, "High", ""),
    ("OMN 1B5B", "Other embedded support", "Mixed", 2200, 2200, 2200, "Low", "Estimated"),
    ("USCG O&S", "Other Equipment & Systems vessel share", "Mixed", 2000, 2100, 2200, "Low", "Analyst estimate"),
]
...
def write_detail_tab(ws, tab_title, purpose, sections, col_count=11):
    ...
    for sec_name, subsections in sections:
        ...
        for sub_name, lines in subsections:
            ...
            for source, item, perf, fy24, fy25, fy26, conf, notes in lines:
                vals = [item, source, fy24, fy25, fy26, None, conf, perf, notes, None, None]
                fonts_d = {
            ...
            if sub_name and len(lines) > 1:
                # Subsection subtotal
                vals = [f"  {sub_name} subtotal", "", sub_fy24, sub_fy25, sub_fy26, None, "", "", "", None, None]
        ...
        # Section total
        vals = [f"{sec_name} total", "", sec_fy24, sec_fy25, sec_fy26, None, "", "", "", None, None]
        write_data_row(ws, r, vals, col_count,
                       fonts={1: FONT_BOLD, 3: FONT_BOLD, 4: FONT_BOLD, 5: FONT_BOLD},
    ...
    # Grand total
    vals = ["Grand total", "", grand_fy24, grand_fy25, grand_fy26, None, "", "", "", None, None]
    write_data_row(ws, r, vals, col_count,
                   fonts={1: FONT_BOLD, 3: FONT_BOLD, 4: FONT_BOLD, 5: FONT_BOLD},
...
OUTPUT_PATH = "topdown_tam_workbook.xlsx"
wb.save(OUTPUT_PATH)
